    ...
    <div class="book-detail__card">
      ...
      <div>
        ...
        <dl class="book-detail__card-body">
          ...
          <dt class="book-detail__card-key" v-if="result.itemCaption">
            商品説明文
          </dt>
          <dd class="book-detail__card-value" v-if="result.itemCaption">
            {{ result.itemCaption }}
          </dd>
        ...
        <div class="book-detail__card-footer">
          <p class="book-detail__card-footer-price">
            ¥{{ result.itemPrice.toLocaleString() }} (税込)
          </p>
          <a :href="result.itemUrl" class="book-detail__card-footer-link">
            購入ページへ
          </a>
        </div>
      </div>
