    ...
    <div class="products-detail__card">
      ...
      <div>
        ...
        <dl class="products-detail__card-body">
          ...
          <a :href="result.shopUrl" class="products-detail__card-value">
            <dd>{{ result.shopName }}</dd>
          </a>

          <dt class="products-detail__card-key" v-if="result.catchcopy">
            商品説明文
          </dt>
          <dd class="products-detail__card-value" v-if="result.catchcopy">
            {{ result.catchcopy }}
          </dd>

          <dt class="products-detail__card-key">レビュー平均</dt>
          <dd class="products-detail__card-value">
            {{ result.reviewAverage }}
          </dd>
        ...
        <div class="products-detail__card-footer">
          <p class="products-detail__card-footer-price">
            ¥{{ result.itemPrice.toLocaleString() }} (税込)
          </p>
          <button
            class="products-detail__card-footer-favorite"
            @click="onClickAddFavorite"
          >
            お気に入りに登録
          </button>
          <a :href="result.itemUrl" class="products-detail__card-footer-link">
            購入ページへ
          </a>
        </div>
      </div>
